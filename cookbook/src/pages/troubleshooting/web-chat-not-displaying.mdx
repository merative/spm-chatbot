---
title: Configuring the web chat
description: How to troubleshoot issues that you might encounter while you are configuring the web chat
---

<u>Table of Contents</u>

* [The web chat is not displaying on Curam SPM pages](#the-web-chat-is-not-displaying-on-curam-pages)
* [Configuring Watson Assistant settings](#configuring-watson-assistant-settings)
...
## The web chat is not displaying on Curam SPM pages

If the web chat is not displaying on Curam SPM pages, ensure that you follow the instructions for [integrating with Watson Assistant](https://www.ibm.com/docs/en/spm/8.0.0?topic=applications-integrating-watson-assistant).

## Configuring Watson Assistant settings
...
*Figure 2: The Watson Assistant web chat when it is spinning.*
...
*Figure 3: The public key is missing in the Watson Assistant web chat security.*
...
*Figure 4: The IntegrationID is missing.*
...
*Figure 5: The region is set incorrectly.*
