...
6. Open the calling dialog node and select 'Jump to' from the dropdown in the `Then assistant should` section. Select the node `#SPL_See_The_Case_Notes_Link` created above to jump to.
7. Test the link in the running application and validate the link opens the correct page in the application.
