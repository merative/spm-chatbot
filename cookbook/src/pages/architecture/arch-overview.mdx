...
IBM® Cúram Social Program Management supports secure integration with the IBM Watson™ Assistant. If enabled, communication between Social Program Management and Watson Assistant is secured by using a JSON Web Token (JWT).
