...
The sample code may be updated to add an `accept-language` request header when calling the REST API in SPM if the localizable text returned in the API is required to be in a language other than english.
