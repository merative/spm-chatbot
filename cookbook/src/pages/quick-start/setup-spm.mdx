---
title: Integrating with IBM® Cúram Social Program Management (SPM)
description: Integrating with IBM® Cúram Social Program Management (SPM)
---
...
+ **SPM on Kubernetes:**
  ...
  Further details about these properties are in the [SPM on Kubernetes guide](https://ibm.github.io/spm-kubernetes/deployment/config-reference/).
