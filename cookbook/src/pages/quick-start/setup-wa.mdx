...
+ Set up the sample functions in IBM Cloud Functions.
...
+ IBM Cloud Functions:
  ...
  + Add the sample code for the actions to your IBM Cloud Functions service from the [Git repository]() and [customize and enable the actions](/functions/edit-a-function). 
+ IBM Watson Assistant:
  + [Import the sample dialog skills](/skills/importing-a-skill) into your Watson Assistant instance from the `CaseworkerAssistantDemo.json` file in the [Git repository]().
